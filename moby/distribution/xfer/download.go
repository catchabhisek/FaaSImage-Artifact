...
func (ldm *LayerDownloadManager) makeDownloadFunc(descriptor DownloadDescriptor, parentLayer layer.ChainID, parentDownload *downloadTransfer) doFunc {
	return func(progressChan chan<- progress.Progress, start <-chan struct{}, inactive chan<- struct{}) transfer {
		...
		go func() {
			...
			logrus.Debugf("PULL_STATS: The download of the layer:%s took: %s", descriptor.ID(), timeElapsed)
			...
			timeElapsed = time.Since(start)
			logrus.Debugf("PULL_STATS: The decompress operation of the layer:%s took: %s", descriptor.ID(), timeElapsed)
			...
			timeElapsed = time.Since(start)
			logrus.Debugf("PULL_STATS: The apply tar operation of the layer:%s took: %s", descriptor.ID(), timeElapsed)
