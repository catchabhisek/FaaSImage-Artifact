...
func untar() {
	...
	// fmt.Fprintln(os.Stdout, "UNTAR: untar(): archive unpack operation took %v", timeElapsed)
...
func invokeUnpack(decompressedArchive io.Reader, dest string, options *archive.TarOptions, root string) error {
	...
	cmd.Stdout = output
	cmd.Stderr = output
	// logrus.Debugf("UNTAR: the command is %s", cmd)
	...
	// timeElapsed := time.Since(start)
	// logrus.Debugf("UNTAR: invokeUnpack():  took %s", timeElapsed)
	logrus.Debugf("UNTAR: The output command of docker-untar is %s", cmd.Stdout)
	return nil
}
